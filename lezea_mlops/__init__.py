...
try:
    ...
    # Verify that the main tracker can be imported
    _TRACKER_AVAILABLE = True
    
except ImportError as e:
    warnings.warn(
        f"Failed to import ExperimentTracker: {e}. "
    ...
    # Create a dummy class for graceful degradation
    class ExperimentTracker:
        def __init__(self, *args, **kwargs):
            raise RuntimeError(
                "ExperimentTracker is not available due to missing dependencies. "
